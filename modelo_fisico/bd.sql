...
/*PessoaServidorDocente(PK(FK_PessoaServidor(id_pessoa)), titulo, cargo, setor, tipo, data_ingresso);*/
...
(
	...
	data_ingresso DATE,
	CONSTRAINT fk_pessoaservidordocente_pessoaservidor FOREIGN KEY (id_pessoa) REFERENCES PessoaServidor(id_pessoa)
	CONSTRAINT pk_pessoaservidordocente PRIMARY KEY (id_pessoa)
);
...
(
	id_pessoa INT NOT NULL,
	CONSTRAINT fk_pessoaservidortecnico_pessoaservidor FOREIGN KEY (id_pessoa) REFERENCES PessoaServidor(id_pessoa),
	CONSTRAINT pk_pessoaservidortecnico PRIMARY KEY (id_pessoa)
);
...
(
	nro_extensao VARCHAR2(30) NOT NULL,
	nro_extensao_anterior VARCHAR2(30),
...
(
	...
	CONSTRAINT fk_programaDeExtensao_extensao FOREIGN KEY (nro_extensao) Extensao(nro_extensao)
);
...
(
	...
	CONSTRAINT fk_area_tem_subareas_area FOREIGN KEY (id_area) Area(id_area)
);
...
(
	...
	CONSTRAINT fk_atividadeDeExtensao_extensao FOREIGN KEY (nro_extensao) Extensao(nro_extensao),
	CONSTRAINT fk_atividadeDeExtensao_programaDeExtensao FOREIGN KEY (nro_extensao_programa) ProgramaDeExtensao(nro_extensao),
	CONSTRAINT fk_atividadeDeExtensao_financiador FOREIGN KEY (id_financiador) Financiador(id_financiador),
	CONSTRAINT fk_atividadeDeExtensao_area1 FOREIGN KEY (id_area_pr) Area(id_area),
	CONSTRAINT fk_atividadeDeExtensao_area2 FOREIGN KEY (id_area_se) Area(id_area)
);
...
(
	...
	CONSTRAINT pk_Aciepe_AtividadeDeExtensao FOREIGN KEY (nro_extensao) AtividadeDeExtensao(nro_extensao)
);
...
(
	...
	CONSTRAINT fk_Aciepe_Encontros_Aciepe FOREIGN KEY (nro_extensao) Aciepe(nro_extensao)
);
...
(
	...
	CONSTRAINT fk_Participante_Pessoa FOREIGN KEY (id_pessoa) Pessoa(id_pessoa),
	CONSTRAINT fk_Participante_AtividadeDeExtensao FOREIGN KEY (nro_extensao) AtividadeDeExtensao(nro_extensao)
);
...
(
	...
	CONSTRAINT fk_Participante_participa_Selecao_Participante FOREIGN KEY (id_pessoa, nro_extensao) Participante(id_pessoa, nro_extensao),
	CONSTRAINT fk_Participante_participa_Selecao_Selecao FOREIGN KEY (id_selecao) Selecao(id_selecao)
);
